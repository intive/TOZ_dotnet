...
namespace Toz.Dotnet.Models.OrganizationSubtypes
{
    public class Address
    {
        ...
        [Required(ErrorMessageResourceType = typeof(Resources.ModelsDataValidation), ErrorMessageResourceName = "EmptyField")]
        [RegularExpression("[0-9]{1,3}[a-zA-Z]{0,2}", ErrorMessageResourceType = typeof(Resources.ModelsDataValidation), ErrorMessageResourceName = "InvalidField")] 
        public string HouseNumber { get; set; }

        [JsonProperty("apartmentNumber")]
        [Required(ErrorMessageResourceType = typeof(Resources.ModelsDataValidation), ErrorMessageResourceName = "EmptyField")]
        [RegularExpression("[0-9]{1,3}", ErrorMessageResourceType = typeof(Resources.ModelsDataValidation), ErrorMessageResourceName = "InvalidField")]  
        public string ApartmentNumber { get; set; }

        [JsonProperty("postCode")]
        [Required(ErrorMessageResourceType = typeof(Resources.ModelsDataValidation), ErrorMessageResourceName = "EmptyField")]
        [RegularExpression("[0-9]{2}-[0-9]{3}", ErrorMessageResourceType = typeof(Resources.ModelsDataValidation), ErrorMessageResourceName = "InvalidField")]     
