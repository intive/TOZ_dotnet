...
namespace Toz.Dotnet.Core.Interfaces
{
    public interface IRestService
    {
        ...
        Task<bool> ExecutePostAction<T>(string address, T obj, string token = default(string), CancellationToken cancelationToken = default(CancellationToken)) where T : class;
